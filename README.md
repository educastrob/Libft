...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><a href=mandatory/ft_isalpha.c>ft_isalpha</a></td>
            <td>Checks whether the passed character is alphabetic.</td>
        </tr>
        <tr>
            <td><a href=mandatory/ft_isascii.c>ft_isascii</a></td>
            <td>Checks whether the passed character is ASCII.</td>
        </tr>
        <tr>
            <td><a href=mandatory/ft_isdigit.c>ft_isdigit</a></td>
            <td>Checks whether the passed character is decimal digit.</td>
        </tr>
        <tr>
            <td><a href=mandatory/ft_isprint.c>ft_isprint</a></td>
            <td>Checks whether the passed character is printable.</td>
        </tr>
        <tr>
            <td><a href=mandatory/ft_tolower.c>ft_tolower</a></td>
            <td>Converts uppercase letters to lowercase.</td>
        </tr>
        <tr>
            <td><a href=mandatory/ft_toupper.c>ft_toupper</a></td>
    ...
    <tbody>
        ...
        <tr>
            <td><a href=mandatory/ft_strrchr.c>ft_strrchr</a></td>
    ...
    <tbody>
        <tr>
            <td><a href=mandatory/ft_atoi.c>ft_atoi</a></td>
            <td>Converts the string to an integer (type int).</td>
        </tr>
        <tr>
            <td><a href=mandatory/ft_calloc.c>ft_calloc</a></td>
    ...
    <tbody>
        ...
        <tr>
            <td><a href=bonus/ft_lstiter.c>ft_lstiter</a></td>
            <td>Iterates the list and applies a function to the content of each element.</td>
        </tr>
        <tr>
            <td><a href=bonus/ft_lstlast.c>ft_lstlast</a></td>
            <td>Returns the last element of the list.</td>
        </tr>
        <tr>
            <td><a href=bonus/ft_lstmap.c>ft_lstmap</a></td>
        ...
        <tr>
            <td><a href=bonus/ft_lstnew.c>ft_lstnew</a></td>
            <td>Returns a new element.</td>
        </tr>
        <tr>
            <td><a href=bonus/ft_lstsize.c>ft_lstsize</a></td>
